...
x
y
answer=(h/3)*(y(1)+4*y(2)+2*y(3)+4*y(4)+y(5));
disp('In Simpson 1/3 rule while h = 1 the answer is')
...
x
y
answer2=(h/3)*(y(1)+4*y(2)+2*y(3)+4*y(4)+2*y(5)+4*y(6)+2*y(7)+4*y(8) +y(9));
disp('In Simpson 1/3 rule while h = 0.5 the answer is')
